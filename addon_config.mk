...
meta:
	ADDON_NAME = ofxZmqModelRunner
	ADDON_DESCRIPTION = ofxZmqModelRunner
	ADDON_AUTHOR = @meredityman
	ADDON_TAGS = "addon" "template"
	ADDON_URL = http://github.com/meredityman/ofxZmqModelRunner

common:
	# dependencies with other addons, a list of them separated by spaces 
	# or use += in several lines
	ADDON_DEPENDENCIES = ofxZmq
